...
// ============================================= 2: THE DIAGNOSIS
{
  ...
  playAs: 'walt',
  tiles: { '#': 'hospwall', '.': 'hospfloor', 'T': 'table', 'b': 'bed' },
  things: {
...
// ============================================= 3: RIDE ALONG
{
  ...
  playAs: 'walt',
  tiles: { '#': 'brick', '.': 'walk', '=': 'roadlin', 'A': 'car', '%': 'wallhome' },
  things: {
    'H': { a: 'hankNpc' },
    'G': { e: 'goon' },
    'h': { p: 'heart' },
  ...
  tick(G, dt) {
    if (G.vars.phase === 0 && G.player.x > 26 * 16) {
      G.vars.phase = 1;
      spawnAt('goon', 30, 6); spawnAt('goon', 32, 8); spawnAt('goon', 33, 9);
...
// ============================================= 4: SHOPPING LIST
{
  ...
  chain: {
    ...
    tiles: { '#': 'brick', '.': 'road', '=': 'roadlin', 'A': 'car', '%': 'wallhome' },
    things: { 'h': { p: 'heart' } },
...
// ============================================= 6: SLINGIN'
{
  ...
  tiles: { '#': 'brick', '.': 'walk', '=': 'roadlin', '-': 'road', 'A': 'car', '%': 'wallhome' },
  things: {
...
// ============================================= 12: THE DEAL
{
  ...
  playAs: 'walt',
  drive: true, vehicle: 'redcar',
  tiles: { '#': 'rock', '.': 'sand', '=': 'roadlin', '-': 'road', 'C': 'cactus' },
...
// ============================================= 18: DEAD FREIGHT
{
  ...
  playAs: 'walt',
  tiles: { '#': 'rock', '.': 'sand', 'r': 'rail', 't': 'train', 'C': 'cactus' },
  things: {
    'W': { e: 'guard' },
  ...
  map: [
    ...
    'tttttttttttt..tttttttttttttttttttt..tttttttttttt',
    'tttttttttttt..tttttttttttttttttttt..tttttttttttt',
    '#.....................Q........................#',
    '#..........W......................W............#',
    '#...C..............C...................C......#',
...
// ==== BEGIN EDITOR CUSTOM MAPS (do not hand-edit; re-merge from the level editor) ====
// Maps customized in editor.html and merged from the browser's saved edits.
const CUSTOM_MAPS = {
  "L0": [
    '########################',
  ...
  "L18": [
    ...
    '.......C...W.C..C..........W....C....C..........',
    '...C....................C....C..................',
    'tt.tttt.tttt.tttt.tttt.tttt.tttt.tttt.tttt.tttt.',
  ...
  "WORLD": [
    ...
    'F,..#########.A..,,.--.,.......#,#######.--.#############,,%%.--.,#########.A.AAA.,F',
    'F,..#########....,,.--.,,......,,,,,,,,,.--.,,,,,,,,,,,,,,,,,.--.,............$...,F',
    'F,.,,,,,1,,g,,,,,,,.--.,,..G...,,,,,l,,,.--.,,A,u,,,R,,o,A,,,.--.,.AA.4.AAA.AAA.A.,F',
    'F.....................................................................z............F',
    'F==================================================================================F',
    'F...........z......................................................................F',
    'F,,############,%%%.--.,########,,TTTT,,.--.,TTTT,,%%%%%%,,,,.--.,######,,########,F',
...
(function () {
  ...
  for (const k in CUSTOM_MAPS) if (reg[k]) reg[k].map = CUSTOM_MAPS[k];
})();
// ==== END EDITOR CUSTOM MAPS ====
