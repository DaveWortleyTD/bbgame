...
// ============================================================
// Level editor overrides (merged from a saved browser session)
// ============================================================
TILE.roadln2 = makeSprite([
  'eeekeeeeeeeeeeee',
  'eekeeeeeeeeeeeke',
  'eeeeeeeeeeekeeee',
  'ekeeekeeeeeeeeee',
...
SOLID.delete('roadln2');
TILE.stairs = makeSprite([
  'aaaaaaaaaaaaaaak',
  'allllaalallalllk',
  'allllllllallkkkk',
  'allllllllllaklll',
...
SOLID.delete('trainjoin');
SPR.doctor = makeSprite([
  '................',
  '......dddd......',
  '.....dddddd.....',
  '.....dddddd.....',
...
if (ROTATE_FAMILIES.doctor) ROTATE_FAMILIES.doctor();
SPR.gusNpc = makeSprite([
  '................',
  '................',
  '.....dddddd.....',
  '.....dTTTTd.....',
...
if (ROTATE_FAMILIES.gusNpc) ROTATE_FAMILIES.gusNpc();
